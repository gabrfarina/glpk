...
size_t AMD_aat(Int n, const Int Ap[], const Int Ai[], Int Len[], Int Tp[],
               double Info[]);
...
void AMD_postorder(Int nn, Int Parent[], Int Npiv[], Int Fsize[], Int Order[],
...
void AMD_preprocess(Int n, const Int Ap[], const Int Ai[], Int Rp[], Int Ri[],
                    Int W[], Int Flag[]);
...
void AMD_dump(Int n, Int Pe[], Int Iw[], Int Len[], Int iwlen, Int pfree,
